...
struct LocalizedStrings {
    ...
    static let ExportPassPackage = NSLocalizedString("Export pass package...", comment: "")
    static let ExportPkpassFile = NSLocalizedString("Export pkpass file...", comment: "")
    ...
    static let EventAttendeePlaceHolder = NSLocalizedString("Attendee Name", comment: "")
    static let EventDates = NSLocalizedString("Dates:", comment: "")
    static let EventDatesPlaceHolder = NSLocalizedString("Event Dates", comment: "")
    static let EventLocation = NSLocalizedString("Location:", comment: "")
